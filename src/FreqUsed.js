...
const rows = [
  ...
  createData('beneName2','beneBankName2', 11111100000002,'beneRef2'),
  createData('beneName3','beneBankName3', 11111100000003,'beneRef3'),
  createData('beneName4','beneBankName4', 11111100000004,'beneRef4'),
  createData('beneName5','beneBankName5', 11111100000005,'beneRef5'),
  createData('beneName6','beneBankName6', 11111100000006,'beneRef6'),
...
export function FreqUsed() {
  ...
  return (
   <div>
    <div align="center">
      <p></p>
      <h2 className="App App-link">Most Frequently Used Beneficiaries</h2>
      <p></p>      
    </div> 
